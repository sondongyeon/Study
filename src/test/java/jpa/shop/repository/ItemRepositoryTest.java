...
import jpa.shop.constant.ItemSellStatus;
import jpa.shop.entity.Item;
import jpa.shop.entity.QItem;
...
class ItemRepositoryTest {
    ...
    public void findByItemNmOrDetailTest(){
        this.createItemList();
        List<Item> itemList=
                itemRepository.findByItemNmOrItemDetail("테스트상품1", "테스트 상품 상세 설명 5");
        for(Item item : itemList){
            System.out.println(item.toString());
        }
    }
